...
class LoaderFooterAdapterController :
    BaseAdapterController<id.co.rezkyauliapratama.libuicomponent.adapter.LoaderAdapterViewMvc, ResourceState>() {

    override fun bind(
        viewMvc: id.co.rezkyauliapratama.libuicomponent.adapter.LoaderAdapterViewMvc,
        itemData: ResourceState?,
        position: Int
    ) {
        mViewMvc = viewMvc
